...
const SSRPopupExample = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setSubmitted(true);
    console.log("SSR Popup Form submitted:", formData);
  };
  ...
  return (
    <Container>
      <Title>{t("passenger_form.special_service_requests")} - Popup Demo</Title>
...
export default SSRPopupExample;
